...
public class HomeworkAnnotations {
    ...
    @DataProvider(name = "generateCalculateSumValues")
    public Object[][] generateCalculateSumValues() {
        return new Object[][]{
                {1, 2, 3},
                {1, 1, 3}
        };
    ...
    @Test(dataProvider = "generateCalculateSumValues" )
    public void calculateSum(int a, int b, int result) {
        int sum = a + b;
    ...
    public void testMultiplicationData(int a, int b, int expectedResult) {
        int actualResult = a * b;
        Assert.assertEquals(actualResult, expectedResult);
    }
